...
public class RendaMensal_Abril_2024View extends javax.swing.JFrame {

    public RendaMensal_Abril_2024View() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RendaMensal_Abril_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RendaMensal_Abril_2024View().setVisible(true);
            }
        });
    }
    ...
    private void ListarRendaMensalFevereiro2024() {
        ...
        try {
            ...
            RendaMensal_Abril_2024DAO objrendamensalabril2024dao = new RendaMensal_Abril_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_RendaMensal_Agosto_2024.getModel();
            model.setNumRows(0);

            ArrayList<RendaMensal_Abril_2024DTO> lista = objrendamensalabril2024dao.PesquisarRendaMensalFevereiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdRendaMensal_Abril_2024(),
...
private void RegistrarRendaMensalFevereiro2024() {
    ...
    objrendamensalabril2024dto.setDescricao(Descricao);
    objrendamensalabril2024dto.setValor_Entrou(Valor_Entrou);
    objrendamensalabril2024dto.setData(Data);
    objrendamensalabril2024dto.setTipo_Entrada(tipo_Entrada);

    // Chamar o método do DAO para registrar os dados
    RendaMensal_Abril_2024DAO objrendamensalabril2024dao = new RendaMensal_Abril_2024DAO();
    objrendamensalabril2024dao.registrarRendaMensalFevereiro2024(objrendamensalabril2024dto);
}
...
private void CarregarCamposFevereiro2024() {
    ...
    private void ExcluirRendaMensalFevereiro2024() {
        try {
            ...
            int idRendaMensal_Abril_2024 = Integer.parseInt(txtidRendaMensal.getText());

            RendaMensal_Abril_2024DTO objrendamensalabril2024dto = new RendaMensal_Abril_2024DTO();
            objrendamensalabril2024dto.setIdRendaMensal_Abril_2024(idRendaMensal_Abril_2024);

            RendaMensal_Abril_2024DAO objrendamensalabril2024dao = new RendaMensal_Abril_2024DAO();
            objrendamensalabril2024dao.ExcluirRendaMensal(objrendamensalabril2024dto);
