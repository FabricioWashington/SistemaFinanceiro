...
public class RendaMensal_Janeiro_2024View extends javax.swing.JFrame {

    public RendaMensal_Janeiro_2024View() {
        initComponents();
        ListarRendaMensalJaneiro2024();
    ...
    private void initComponents() {
        ...
        Tabela_RendaMensal_Janeiro_2024 = new javax.swing.JTable();
        ...
        Tabela_RendaMensal_Janeiro_2024.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Tabela_RendaMensal_Janeiro_2024);
    ...
    private void btnRegistro_InserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistro_InserirActionPerformed
        RegistrarRendaMensalJaneiro2024();
        ListarRendaMensalJaneiro2024();
        LimparCamposJaneiro2024();
        atualizarValor(BigDecimal.ZERO, txtValor_Total_Entrou);
        ExibirCalculoTotalEntradas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RendaMensal_Janeiro_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RendaMensal_Janeiro_2024View().setVisible(true);
            }
        });
    }

    private void ListarRendaMensalJaneiro2024() {

        try {

            RendaMensal_Janeiro_2024DAO objrendamensaljaneiro2024dao = new RendaMensal_Janeiro_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_RendaMensal_Janeiro_2024.getModel();
            model.setNumRows(0);

            ArrayList<RendaMensal_Janeiro_2024DTO> lista = objrendamensaljaneiro2024dao.PesquisarRendaMensalJaneiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdRendaMensal_Janeiro_2024(),
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro em ListarRegistros em RegistrosView" + erro);
        }

    }

private void RegistrarRendaMensalJaneiro2024() {
    String Descricao;
    ...
    BigDecimal Valor_Total_Entradas = BigDecimal.ZERO; // Valor padrão, ajuste conforme necessário
    ...
    objrendamensaljaneiro2024dto.setDescricao(Descricao);
    objrendamensaljaneiro2024dto.setValor_Entrou(Valor_Entrou);
    objrendamensaljaneiro2024dto.setData(Data);
    objrendamensaljaneiro2024dto.setTipo_Entrada(tipo_Entrada);

    // Chamar o método do DAO para registrar os dados
    RendaMensal_Janeiro_2024DAO objrendamensaljaneiro2024dao = new RendaMensal_Janeiro_2024DAO();
    objrendamensaljaneiro2024dao.registrarRendaMensalJaneiro2024(objrendamensaljaneiro2024dto);
}


private void CarregarCamposJaneiro2024() {
    int setar = Tabela_RendaMensal_Janeiro_2024.getSelectedRow();

    //verificar se há uma linha selecionada
    if (setar >= 0 && setar < Tabela_RendaMensal_Janeiro_2024.getRowCount()) {
        txtidRendaMensal.setText(Tabela_RendaMensal_Janeiro_2024.getModel().getValueAt(setar, 0).toString());
        txtDescricao.setText(Tabela_RendaMensal_Janeiro_2024.getModel().getValueAt(setar, 1).toString());
        txtValor_Entrou.setText(Tabela_RendaMensal_Janeiro_2024.getModel().getValueAt(setar, 2).toString());

        // Carregar a data no formato dd/MM/yyyy
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        try {
            Date data = (Date) Tabela_RendaMensal_Janeiro_2024.getModel().getValueAt(setar, 3);
...
private void AlterarRendaMensalJaneiro2024() {
    try {
        ...
        int IdRendaMensal_Janeiro_2024 = Integer.parseInt(txtidRendaMensal.getText());
        ...
        RendaMensal_Janeiro_2024DTO objrendamensaljaneiro2024dto = new RendaMensal_Janeiro_2024DTO();
        objrendamensaljaneiro2024dto.setIdRendaMensal_Janeiro_2024(IdRendaMensal_Janeiro_2024);
        objrendamensaljaneiro2024dto.setDescricao(Descricao);
        objrendamensaljaneiro2024dto.setData(Data_Entrou);
        objrendamensaljaneiro2024dto.setValor_Entrou(Valor_Entrou);

        RendaMensal_Janeiro_2024DAO objrendamensaljaneiro2024dao = new RendaMensal_Janeiro_2024DAO();
        objrendamensaljaneiro2024dao.alterarRendaMensalJaneiro2024(objrendamensaljaneiro2024dto);

        // Exibir método atualizar valor com BigDecimal.ZERO e txtValor_Total_Entrou
        atualizarValor(BigDecimal.ZERO.setScale(2, RoundingMode.HALF_UP), txtValor_Total_Entrou);
    } catch (ParseException e) {
    ...
    private void ExcluirRendaMensalJaneiro2024() {
        try {
            if (txtidRendaMensal.getText().isEmpty()) {
            ...
            RendaMensal_Janeiro_2024DAO objrendamensaljaneiro2024dao = new RendaMensal_Janeiro_2024DAO();
            objrendamensaljaneiro2024dao.ExcluirRendaMensal(objrendamensaljaneiro2024dto);
 ...
 private void atualizarValor(BigDecimal valor, JTextField txtValor_Total_Entrou) {
    ...
    private javax.swing.JTable Tabela_RendaMensal_Janeiro_2024;
