...
import DTO.Registro_Julho_2024DTO;
...
public class Registro_Julho_2024View extends javax.swing.JFrame {

    public Registro_Julho_2024View() {
        initComponents();
        ListarRegistros();
        ExibirCalculoTotal();
    }
    ...
    private void initComponents() {
        ...
        Tabela_Registro_Julho_2024 = new javax.swing.JTable();
        ...
        Tabela_Registro_Julho_2024.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(Tabela_Registro_Julho_2024);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_Julho_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registro_Julho_2024View().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Tabela_Registro_Julho_2024;
    ...
    private void ListarRegistros() {
        ...
        try {
            ...
            Registro_Julho_2024DAO objregistrojulho2024dao = new Registro_Julho_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_Registro_Julho_2024.getModel();
            model.setNumRows(0);

            ArrayList<Registro_Julho_2024DTO> lista = objregistrojulho2024dao.PesquisarRegistroFevereiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdSaidas_Julho_2024(),
    ...
    private void RegistrarDadosFevereiro2024() {
        ...
        Registro_Julho_2024DTO objregistrojulho2024dto = new Registro_Julho_2024DTO();
        objregistrojulho2024dto.setClassificicacao(Classificacao);
        objregistrojulho2024dto.setDespesas(Despesas);
        objregistrojulho2024dto.setObs(Obs);
        objregistrojulho2024dto.setValor(Valor);
        objregistrojulho2024dto.setPagamento(Pagamento);
        objregistrojulho2024dto.setData(Data);
        objregistrojulho2024dto.setTipo(Tipo);
        objregistrojulho2024dto.setValor_Total_Saidas(Valor_Total_Saidas);
        objregistrojulho2024dto.setTipo_saida(tipo_saida);

        // Chamar o método do DAO para registrar os dados
        Registro_Julho_2024DAO objregistrojulho2024dao = new Registro_Julho_2024DAO();
        objregistrojulho2024dao.registrarDados(objregistrojulho2024dto);
    }

    private void CarregarCamposFevereiro2024() {
        int setar = Tabela_Registro_Julho_2024.getSelectedRow();

        // Verificar se há uma linha selecionada
        if (setar >= 0 && setar < Tabela_Registro_Julho_2024.getRowCount()) {
            txtCodigo.setText(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 0).toString());
            cbx_Classificacao.setSelectedItem(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 1).toString());
            txtDespesas.setText(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 2).toString());

            // Carregar a data no formato dd/MM/yyyy
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            try {
                Date data = (Date) Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 3);
                txtData.setText(sdf.format(data));
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Erro ao carregar a data.");
            }

            txtValor.setText(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 4).toString());
            cbx_Pagamento.setSelectedItem(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 5).toString());
            txtObs.setText(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 6).toString());
            cbx_Tipo.setSelectedItem(Tabela_Registro_Julho_2024.getModel().getValueAt(setar, 7).toString());
        }
    }
    ...
    private void AlterarRegistroFevereiro2024() {
        try {
            ...
            int idSaidas_Julho_2024 = Integer.parseInt(txtCodigo.getText());
            ...
            Registro_Julho_2024DTO objregistrojulho2024dto = new Registro_Julho_2024DTO();
            objregistrojulho2024dto.setIdSaidas_Julho_2024(idSaidas_Julho_2024);
            objregistrojulho2024dto.setClassificicacao(Classificacao);
            objregistrojulho2024dto.setDespesas(Despesas);
            objregistrojulho2024dto.setData(Data);
            objregistrojulho2024dto.setValor(Valor);
            ...
            Registro_Julho_2024DAO objregistrojulho2024dao = new Registro_Julho_2024DAO();
            objregistrojulho2024dao.alterarRegistroFevereiro2024(objregistrojulho2024dto);
    ...
    private void ExcluirRegistrosFevereiro2024() {
        try {
            ...
            Registro_Julho_2024DAO objregistrojulho2024dao = new Registro_Julho_2024DAO();
            objregistrojulho2024dao.ExcluirRegistros(objregistrojulho2024dto);
        } catch (NumberFormatException e) {
