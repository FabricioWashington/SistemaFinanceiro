...
public class Registro_Janeiro_2024View extends javax.swing.JFrame {

    public Registro_Janeiro_2024View() {
        initComponents();
        ListarRegistros();
        ExibirCalculoTotal();
    }
    ...
    private void initComponents() {
        ...
        Tabela_Registro_Janeiro_2024 = new javax.swing.JTable();
        ...
        Tabela_Registro_Janeiro_2024.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(Tabela_Registro_Janeiro_2024);
        ...
        setSize(new java.awt.Dimension(1266, 723));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_Janeiro_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registro_Janeiro_2024View().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Tabela_Registro_Janeiro_2024;
    ...
    private void ListarRegistros() {
        ...
        try {
            ...
            Registro_Janeiro_2024DAO objregistrojaneiro2024dao = new Registro_Janeiro_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_Registro_Janeiro_2024.getModel();
            model.setNumRows(0);

            ArrayList<Registro_Janeiro_2024DTO> lista = objregistrojaneiro2024dao.PesquisarRegistroJaneiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdSaidas_Janeiro_2024(),
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro em ListarRegistrosJaneiro2024 em RegistrosView" + erro);
        }

    }

    private void RegistrarDadosJaneiro2024() {
        ...
        Registro_Janeiro_2024DTO objregistrojaneiro2024dto = new Registro_Janeiro_2024DTO();
        objregistrojaneiro2024dto.setClassificacao(Classificacao);
        objregistrojaneiro2024dto.setDespesas(Despesas);
        objregistrojaneiro2024dto.setObs(Obs);
        objregistrojaneiro2024dto.setValor(Valor);
        objregistrojaneiro2024dto.setPagamento(Pagamento);
        objregistrojaneiro2024dto.setData(Data);
        objregistrojaneiro2024dto.setTipo(Tipo);
        objregistrojaneiro2024dto.setValor_Total_Saidas(Valor_Total_Saidas);
        objregistrojaneiro2024dto.setTipo_saida(tipo_saida);

        // Chamar o método do DAO para registrar os dados
        Registro_Janeiro_2024DAO objregistrojaneiro2024dao = new Registro_Janeiro_2024DAO();
        objregistrojaneiro2024dao.registrarDados(objregistrojaneiro2024dto);
    }

    private void CarregarCamposJaneiro2024() {
        int setar = Tabela_Registro_Janeiro_2024.getSelectedRow();

        // Verificar se há uma linha selecionada
        if (setar >= 0 && setar < Tabela_Registro_Janeiro_2024.getRowCount()) {
            txtCodigo.setText(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 0).toString());
            cbx_Classificacao.setSelectedItem(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 1).toString());
            txtDespesas.setText(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 2).toString());

            // Carregar a data no formato dd/MM/yyyy
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            try {
                Date data = (Date) Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 3);
                txtData.setText(sdf.format(data));
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Erro ao carregar a data.");
            }

            txtValor.setText(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 4).toString());
            cbx_Pagamento.setSelectedItem(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 5).toString());
            txtObs.setText(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 6).toString());
            cbx_Tipo.setSelectedItem(Tabela_Registro_Janeiro_2024.getModel().getValueAt(setar, 7).toString());
        }
    }

    private void ExcluirRegistrosJaneiro2024() {
        try {
            ...
            int idSaidas_Janeiro_2024 = Integer.parseInt(txtCodigo.getText());

            Registro_Janeiro_2024DTO objregistrojaneiro2024dto = new Registro_Janeiro_2024DTO();
            objregistrojaneiro2024dto.setIdSaidas_Janeiro_2024(idSaidas_Janeiro_2024);

            Registro_Janeiro_2024DAO objregistrojaneiro2024dao = new Registro_Janeiro_2024DAO();
            objregistrojaneiro2024dao.ExcluirRegistros(objregistrojaneiro2024dto);
        } catch (NumberFormatException e) {
