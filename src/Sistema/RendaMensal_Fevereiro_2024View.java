...
public class RendaMensal_Fevereiro_2024View extends javax.swing.JFrame {

    public RendaMensal_Fevereiro_2024View() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tabela_RendaMensal_Fevereiro_2024 = new javax.swing.JTable();
        ...
        Tabela_RendaMensal_Fevereiro_2024.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Tabela_RendaMensal_Fevereiro_2024);
        ...
        jLabel6.setText("FEVEREIRO 2024");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RendaMensal_Fevereiro_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RendaMensal_Fevereiro_2024View().setVisible(true);
            }
        });
    }
    ...
    private void ListarRendaMensalFevereiro2024() {
        ...
        try {
            ...
            RendaMensal_Fevereiro_2024DAO objrendamensaljaneiro2024dao = new RendaMensal_Fevereiro_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_RendaMensal_Fevereiro_2024.getModel();
            model.setNumRows(0);

            ArrayList<RendaMensal_Fevereiro_2024DTO> lista = objrendamensaljaneiro2024dao.PesquisarRendaMensalFevereiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdRendaMensal_Fevereiro_2024(),
...
private void RegistrarRendaMensalFevereiro2024() {
    ...
    objrendamensalfevereiro2024dto.setDescricao(Descricao);
    objrendamensalfevereiro2024dto.setValor_Entrou(Valor_Entrou);
    objrendamensalfevereiro2024dto.setData(Data);
    objrendamensalfevereiro2024dto.setTipo_Entrada(tipo_Entrada);

    // Chamar o método do DAO para registrar os dados
    RendaMensal_Fevereiro_2024DAO objrendamensalfevereiro2024dao = new RendaMensal_Fevereiro_2024DAO();
    objrendamensalfevereiro2024dao.registrarRendaMensalFevereiro2024(objrendamensalfevereiro2024dto);
}

private void CarregarCamposFevereiro2024() {
    int setar = Tabela_RendaMensal_Fevereiro_2024.getSelectedRow();

    //verificar se há uma linha selecionada
    if (setar >= 0 && setar < Tabela_RendaMensal_Fevereiro_2024.getRowCount()) {
        txtidRendaMensal.setText(Tabela_RendaMensal_Fevereiro_2024.getModel().getValueAt(setar, 0).toString());
        txtDescricao.setText(Tabela_RendaMensal_Fevereiro_2024.getModel().getValueAt(setar, 1).toString());
        txtValor_Entrou.setText(Tabela_RendaMensal_Fevereiro_2024.getModel().getValueAt(setar, 2).toString());

        // Carregar a data no formato dd/MM/yyyy
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        try {
            Date data = (Date) Tabela_RendaMensal_Fevereiro_2024.getModel().getValueAt(setar, 3);
...
private void AlterarRendaMensalFevereiro2024() {
    try {
        ...
        int IdRendaMensal_Fevereiro_2024 = Integer.parseInt(txtidRendaMensal.getText());
        ...
        RendaMensal_Fevereiro_2024DTO objrendamensalfevereiro2024dto = new RendaMensal_Fevereiro_2024DTO();
        objrendamensalfevereiro2024dto.setIdRendaMensal_Fevereiro_2024(IdRendaMensal_Fevereiro_2024);
        objrendamensalfevereiro2024dto.setDescricao(Descricao);
        objrendamensalfevereiro2024dto.setData(Data_Entrou);
        objrendamensalfevereiro2024dto.setValor_Entrou(Valor_Entrou);

        RendaMensal_Fevereiro_2024DAO objrendamensalfevereiro2024dao = new RendaMensal_Fevereiro_2024DAO();
        objrendamensalfevereiro2024dao.alterarRendaMensalFevereiro2024(objrendamensalfevereiro2024dto);
    ...
    private void ExcluirRendaMensalFevereiro2024() {
        try {
            ...
            RendaMensal_Fevereiro_2024DAO objrendamensalfevereiro2024dao = new RendaMensal_Fevereiro_2024DAO();
            objrendamensalfevereiro2024dao.ExcluirRendaMensal(objrendamensalfevereiro2024dto);
 ...
 private void atualizarValor(BigDecimal valor, JTextField txtValor_Total_Entrou) {
    ...
    private javax.swing.JTable Tabela_RendaMensal_Fevereiro_2024;
