...
public class RendaMensal_Agosto_2024View extends javax.swing.JFrame {

    public RendaMensal_Agosto_2024View() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tabela_RendaMensal_Agosto_2024 = new javax.swing.JTable();
        ...
        Tabela_RendaMensal_Agosto_2024.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Tabela_RendaMensal_Agosto_2024);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RendaMensal_Agosto_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RendaMensal_Agosto_2024View().setVisible(true);
            }
        });
    }
    ...
    private void ListarRendaMensalFevereiro2024() {
        ...
        try {
            ...
            RendaMensal_Agosto_2024DAO objrendamensalagosto2024dao = new RendaMensal_Agosto_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_RendaMensal_Agosto_2024.getModel();
            model.setNumRows(0);

            ArrayList<RendaMensal_Agosto_2024DTO> lista = objrendamensalagosto2024dao.PesquisarRendaMensalFevereiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdRendaMensal_Agosto_2024(),
...
private void RegistrarRendaMensalFevereiro2024() {
    ...
    objrendamensalagosto2024dto.setDescricao(Descricao);
    objrendamensalagosto2024dto.setValor_Entrou(Valor_Entrou);
    objrendamensalagosto2024dto.setData(Data);
    objrendamensalagosto2024dto.setTipo_Entrada(tipo_Entrada);

    // Chamar o método do DAO para registrar os dados
    RendaMensal_Agosto_2024DAO objrendamensalagosto2024dao = new RendaMensal_Agosto_2024DAO();
    objrendamensalagosto2024dao.registrarRendaMensalFevereiro2024(objrendamensalagosto2024dto);
}

private void CarregarCamposFevereiro2024() {
    int setar = Tabela_RendaMensal_Agosto_2024.getSelectedRow();

    //verificar se há uma linha selecionada
    if (setar >= 0 && setar < Tabela_RendaMensal_Agosto_2024.getRowCount()) {
        txtidRendaMensal.setText(Tabela_RendaMensal_Agosto_2024.getModel().getValueAt(setar, 0).toString());
        txtDescricao.setText(Tabela_RendaMensal_Agosto_2024.getModel().getValueAt(setar, 1).toString());
        txtValor_Entrou.setText(Tabela_RendaMensal_Agosto_2024.getModel().getValueAt(setar, 2).toString());

        // Carregar a data no formato dd/MM/yyyy
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        try {
            Date data = (Date) Tabela_RendaMensal_Agosto_2024.getModel().getValueAt(setar, 3);
...
private void AlterarRendaMensalFevereiro2024() {
    try {
        ...
        int IdRendaMensal_Agosto_2024 = Integer.parseInt(txtidRendaMensal.getText());
        ...
        RendaMensal_Agosto_2024DTO objrendamensalagosto2024dto = new RendaMensal_Agosto_2024DTO();
        objrendamensalagosto2024dto.setIdRendaMensal_Agosto_2024(IdRendaMensal_Agosto_2024);
        objrendamensalagosto2024dto.setDescricao(Descricao);
        objrendamensalagosto2024dto.setData(Data_Entrou);
        objrendamensalagosto2024dto.setValor_Entrou(Valor_Entrou);

        RendaMensal_Agosto_2024DAO objrendamensalagosto2024dao = new RendaMensal_Agosto_2024DAO();
        objrendamensalagosto2024dao.alterarRendaMensalFevereiro2024(objrendamensalagosto2024dto);
    ...
    private void ExcluirRendaMensalFevereiro2024() {
        try {
            ...
            RendaMensal_Agosto_2024DAO objrendamensalagosto2024dao = new RendaMensal_Agosto_2024DAO();
            objrendamensalagosto2024dao.ExcluirRendaMensal(objrendamensalagosto2024dto);
 ...
 private void atualizarValor(BigDecimal valor, JTextField txtValor_Total_Entrou) {
    ...
    private javax.swing.JTable Tabela_RendaMensal_Agosto_2024;
