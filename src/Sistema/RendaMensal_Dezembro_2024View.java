...
public class RendaMensal_Dezembro_2024View extends javax.swing.JFrame {

    public RendaMensal_Dezembro_2024View() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tabela_RendaMensal_Dezembro_2024 = new javax.swing.JTable();
        ...
        Tabela_RendaMensal_Dezembro_2024.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Tabela_RendaMensal_Dezembro_2024);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RendaMensal_Dezembro_2024View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RendaMensal_Dezembro_2024View().setVisible(true);
            }
        });
    }
    ...
    private void ListarRendaMensalFevereiro2024() {
        ...
        try {
            ...
            RendaMensal_Dezembro_2024DAO objrendamensaldezembro2024dao = new RendaMensal_Dezembro_2024DAO();

            DefaultTableModel model = (DefaultTableModel) Tabela_RendaMensal_Dezembro_2024.getModel();
            model.setNumRows(0);

            ArrayList<RendaMensal_Dezembro_2024DTO> lista = objrendamensaldezembro2024dao.PesquisarRendaMensalFevereiro2024();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getIdRendaMensal_Dezembro_2024(),
...
private void RegistrarRendaMensalFevereiro2024() {
    ...
    objrendamensaldezembro2024dto.setDescricao(Descricao);
    objrendamensaldezembro2024dto.setValor_Entrou(Valor_Entrou);
    objrendamensaldezembro2024dto.setData(Data);
    objrendamensaldezembro2024dto.setTipo_Entrada(tipo_Entrada);

    // Chamar o método do DAO para registrar os dados
    RendaMensal_Dezembro_2024DAO objrendamensaldezembro2024dao = new RendaMensal_Dezembro_2024DAO();
    objrendamensaldezembro2024dao.registrarRendaMensalFevereiro2024(objrendamensaldezembro2024dto);
}

private void CarregarCamposFevereiro2024() {
    int setar = Tabela_RendaMensal_Dezembro_2024.getSelectedRow();

    //verificar se há uma linha selecionada
    if (setar >= 0 && setar < Tabela_RendaMensal_Dezembro_2024.getRowCount()) {
        txtidRendaMensal.setText(Tabela_RendaMensal_Dezembro_2024.getModel().getValueAt(setar, 0).toString());
        txtDescricao.setText(Tabela_RendaMensal_Dezembro_2024.getModel().getValueAt(setar, 1).toString());
        txtValor_Entrou.setText(Tabela_RendaMensal_Dezembro_2024.getModel().getValueAt(setar, 2).toString());

        // Carregar a data no formato dd/MM/yyyy
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        try {
            Date data = (Date) Tabela_RendaMensal_Dezembro_2024.getModel().getValueAt(setar, 3);
...
private void AlterarRendaMensalFevereiro2024() {
    try {
        ...
        int IdRendaMensal_Dezembro_2024 = Integer.parseInt(txtidRendaMensal.getText());
        ...
        RendaMensal_Dezembro_2024DTO objrendamensaldezembro2024dto = new RendaMensal_Dezembro_2024DTO();
        objrendamensaldezembro2024dto.setIdRendaMensal_Dezembro_2024(IdRendaMensal_Dezembro_2024);
        objrendamensaldezembro2024dto.setDescricao(Descricao);
        objrendamensaldezembro2024dto.setData(Data_Entrou);
        objrendamensaldezembro2024dto.setValor_Entrou(Valor_Entrou);

        RendaMensal_Dezembro_2024DAO objrendamensaldezembro2024dao = new RendaMensal_Dezembro_2024DAO();
        objrendamensaldezembro2024dao.alterarRendaMensalFevereiro2024(objrendamensaldezembro2024dto);
    ...
    private void ExcluirRendaMensalFevereiro2024() {
        try {
            ...
            RendaMensal_Dezembro_2024DAO objrendamensaldezembro2024dao = new RendaMensal_Dezembro_2024DAO();
            objrendamensaldezembro2024dao.ExcluirRendaMensal(objrendamensaldezembro2024dto);
 ...
 private void atualizarValor(BigDecimal valor, JTextField txtValor_Total_Entrou) {
    ...
    private javax.swing.JTable Tabela_RendaMensal_Dezembro_2024;
