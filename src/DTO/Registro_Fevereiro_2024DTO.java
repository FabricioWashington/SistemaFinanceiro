...
public class Registro_Fevereiro_2024DTO {
    private int idSaidas_Fevereiro_2024;
    private String Classificacao,Despesas, Pagamento, Obs, Tipo, tipo_saida;
    private BigDecimal Valor, Valor_Total_Saidas;
    private Date Data;

    /**
     * @return the idSaidas_Fevereiro_2024
     */
    public int getIdSaidas_Fevereiro_2024() {
        return idSaidas_Fevereiro_2024;
    }

    /**
     * @param idSaidas_Fevereiro_2024 the idSaidas_Fevereiro_2024 to set
     */
    public void setIdSaidas_Fevereiro_2024(int idSaidas_Fevereiro_2024) {
        this.idSaidas_Fevereiro_2024 = idSaidas_Fevereiro_2024;
    }
